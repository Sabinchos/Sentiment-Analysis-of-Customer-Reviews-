...
1. Генерация синтетических примеров с помощью перефразирования только для обучающей выборки (`data_with_sentiment_new.xlsx`)
2. Объединение оригинальных и синтетических записей в один набор данных (`balanced_data_80_balanced.xlsx`)  
